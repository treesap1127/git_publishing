...
<body>
     ...
     <!--여기까지 기본 위 배너 입니다!-->
    <div class="top_box">
      <div class="top_box_name">${sessionScope.member.userName}님은 <span style="color: brown;width: 100%;">일반 회원</span>입니다</div>
    ...
    <div class="my_page" style="display: flex;">
      ...
      <div class="ticket_check_cancle">
		...
		<c:if test="${TicketItem.size()==0}">
			<div class="fail_info">
				<div class="complete_text" style="width: 100%;text-align: center;position: relative;top: 29%;">
					예매 내역이 아직 존재하지 않습니다.
				</div>
			</div>
		</c:if>
