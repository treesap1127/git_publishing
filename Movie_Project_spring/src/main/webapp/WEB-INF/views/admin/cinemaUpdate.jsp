  ...
  <!--여기까지 기본 위 배너 입니다!-->
     <div class="center_box">
      ...
      <form method="post" class="mt-4">
          ...
          <label>시/도</label>	
          <div>
         	 <select name="bigCity" id="selectBox" class="form-control" style="padding-top:0;padding-bottom:0;">
          ...
          <label>전화번호</label>	
          <div>
          <input type="tel" name="tel" id="tel" class="form-control" value="${item.tel}" placeholder="010-0000-0000">
          </div>
          <br>   
          <label>영화관명</label>	
          <div>
          <input type="text" name="movieAreaName" class="form-control" value="${item.movieAreaName}" placeholder="달빛 충무로점">
          </div>      
        <div>        	
          ...
          <a href="../../webadmin/myCinema" class="btn btn-outline-primary">목록가기</a></div>						
        </div>     
      </form>
    </div>
